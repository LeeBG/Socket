...
$.extend($.jgrid,{
	...
	gridUnload : function ( jqGridId ) {
		...
		if ($t.p.pager) {
			$($t.p.pager).off().empty().removeClass("  ui-jqgrid-pager ui-corner-bottom");
		}
	...
	styleUI : {
		jQueryUI : {
			...
			base : {
				entrieBox : "ui-widget ui-corner-all", // entrie div  incl everthing
				viewBox : "", // view diw
				headerTable : "",
				rowTable : "",
				...
				icon_first : "trs_icon_leftend",
				icon_prev : "trs_icon_left",
				icon_next: "trs_icon_right",
				icon_end: "trs_icon_rightend",
				icon_asc : "trs_icon_asc",
				icon_desc : "trs_icon_desc",
				icon_caption_open : "ui-icon-circle-triangle-n",
				icon_caption_close : "ui-icon-circle-triangle-s"
			},
			modal : {
				modal : "ui-widget ui-corner-all ui-dialog",
				header : "r ui-corner-all ui-helper-clearfix",
				resizable : "ui-resizable-handle ui-resizable-se",
				icon_close : "ui-icon-closethick",
				icon_resizable : "ui-icon-gripsmall-diagonal-se"
			},
			celledit : {
				inputClass : " ui-corner-all"
			},
			inlinedit : {
				inputClass : " ui-corner-all",
			...
			filter : {
				table_widget : 'ui-widget ',
				srSelect : ' ui-corner-all',
				srInput : ' ui-corner-all',
				menu_widget : 'ui-widget  ui-corner-all',
			...
			colmenu : {
				menu_widget : 'ui-widget  ui-corner-all',
				input_checkbox : "ui-widget ",
				filter_select: " ui-corner-all",
				filter_input : "  ui-corner-all",
	...
	return this.each( function() {
		...
		setPager = function (pgid, tp){
			...
			if(ts.p.rowList.length >0){
				str = "<td dir=\""+dir+"\">";
				str +="<select "+getstyle(stylemodule, 'pgSelectBox', false, 'ui-pg-selbox grid-selbox')+" size=\"1\" role=\"listbox\" title=\""+($.jgrid.getRegional(ts,"defaults.pgrecs",ts.p.pgrecs) || "")+ "\">";
				var strnm;
			...
			if (o.useColSpanStyle) {
				...
				$htable.find("div.ui-jqgrid-sortable").each(function () {
					var $ts = $(this), $parent = $ts.parent();
						if($parent.attr('id') == "mainGrid_filter_count" || $parent.attr('id') == "mainGrid_forgery_count" || $parent.attr('id') == "mainGrid_protect_count" || $parent.attr('id') == "mainGrid_suspicious_count"||
								$parent.attr('id') == "mainGrid_infected_count" || $parent.attr('id') == "mainGrid_scan_fail_count"){
							$ts.css('height','auto');
							$ts.css('top','3px');
						}else{
...
$.jgrid.extend({
	...
	jqPivot : function( data, pivotOpt, gridOpt, ajaxOpt) {
		return this.each(function(){
			...
			if(pivotOpt.loadMsg) {
				$("<div class='loading_pivot   ui-state-active row'>"+$.jgrid.getRegional($t, "regional."+regional+".defaults.loadtext")+"</div>").insertBefore($t).show();
			}
