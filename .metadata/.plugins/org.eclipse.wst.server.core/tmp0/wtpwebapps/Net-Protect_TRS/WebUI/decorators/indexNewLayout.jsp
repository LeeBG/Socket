...
<%-- <c:choose>
	<c:when test="${fn:indexOf(requestURI, '/sign/index.lin') > -1}">
		<link href="<c:url value="/css/new_login_posid.css" />" rel="stylesheet" type="text/css" />
	</c:when>
	<c:otherwise>
		<link href="<c:url value="/css/new_login.css" />" rel="stylesheet" type="text/css" />
	</c:otherwise>
</c:choose> --%>
<link href="<c:url value="/css/renewal_login.css" />?v=20220108" rel="stylesheet" type="text/css" />
...
<script type="text/javascript" src="<c:url value="/JavaScript/jquery.js" />?v=210126"></script>
<script type="text/javascript" src="<c:url value="/JavaScript/jquery-ui.js" />"></script>
<script type="text/javascript" src="<c:url value="/JavaScript/common.js" />?v=210129"></script>
<c:if test="${ isIE9 }">
