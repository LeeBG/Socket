...
<script type="text/javascript">
	...
	function insert(){
		...
		var successURL = "<c:url value="/users/user/addAdminUserList.lin" />";
...
<div id="contentPageHeader">
	...
	<div id="contentPageLocation">
		<ul>
			...
			<li class="Llast"><span>관리자 추가</span></li>
		</ul>
	</div>
</div>
	...
	<caption>직번, 이름, 부서, 결재권한</caption>
		<colgroup>
			...
			<tbody>
				<tr>
					<td>
						<label for="users_id" class="mg_l15"><spring:message code="global.script.id" /></label>
						<input id="users_id" name="users_id" type="text" class="text_input"/>
					</td>
					<td>
						<label for="users_nm"><spring:message code="user.addUserlist.list.insert.users_nm" /></label>
						<input id="users_nm" name="users_nm" type="text" class="text_input"/>
					</td>
					<%-- <td>
					...
					<td>
						<label for="auth_type"><spring:message code="user.addUserlist.list.insert.approver_type" /></label>
						<select id="auth_type" name="auth_type" style="margin-left: 5px;">
...
<div class="vc_scan_status_info_box" style="width:792px; font-weight: bold; text-align: left">
	<span class="pd_l12px">ADMIN : 원본파일 열람 가능, &nbsp;&nbsp;&nbsp; MANAGER : 원본파일 열람 불가</span>
</div>
