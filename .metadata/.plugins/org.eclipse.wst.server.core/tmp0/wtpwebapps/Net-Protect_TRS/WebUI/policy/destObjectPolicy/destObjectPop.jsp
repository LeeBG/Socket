...
$(document).ready(function() {
	...
	$("#reset").click(function() {
		var dest_object_val = $("#dest_object_val", opener.document).val();
		location.href = "<c:url value="/policy/destObjectPolicy/destObjectPop.lin" />?notSeq="+dest_object_val;
	});
	...
	$("#addParent").click(function(){	//부모창으로 객체 전송
		...
		window.opener.addDestObjects(chks);
		if(chks.length > 0) {
			window.close();
		}
	});
...
function search() {
	...
	$("#notSeq").val($("#dest_object_val", opener.document).val());
...
<body>
<form id="lform" name="lform" onsubmit="return false;" method="post" action='<c:url value="/policy/destObjectPolicy/destObjectPop.lin" />' >
	...
	<div>
		<!-- <div class="topWarp">
			<div class="titleBox">
				...
				<p class="breadCrumbs">&nbsp;&nbsp;&nbsp;목적지객체 관리</p>
			</div>
		</div> -->
			<div class="conWrap">
				<h3>검색조건</h3>
							...
							<tbody>
								...
								<tr style="border-bottom: solid 1px #ddd;">
									...
									<td colspan="2">
										...
										&#126;
										<span class="search_day">
											<input type="text" name="endDay" id="endDay" value="${destObjectForm.endDay}" readonly="readonly" class="text_input short t_center" style="width: 100px;" />
