...
$(document).ready(function() {
	...
	$("#reset").click(function() {
		var ip_object_group_val = $("#ip_object_group_val", opener.document).val();
		location.href = "<c:url value="/policy/ipObjectPolicy/ipObjectGroupPop.lin" />?notSeq="+ip_object_group_val;
	});
	...
	$("#addParent").click(function(){	//부모창으로 객체 전송
		...
		window.opener.addIpObjectGroup(chks);
		if(chks.length > 0) {
			window.close();
		}
	});
...
function search() {
	...
	$("#notSeq").val($("#ip_object_group_val", opener.document).val());
	...
	<div>
		<!-- <div class="topWarp">
			<div class="titleBox">
				...
				<p class="breadCrumbs">&nbsp;&nbsp;&nbsp;IP객체 그룹관리</p>
			</div>
		</div> -->
			<div class="conWrap">
				<h3>검색조건</h3>
