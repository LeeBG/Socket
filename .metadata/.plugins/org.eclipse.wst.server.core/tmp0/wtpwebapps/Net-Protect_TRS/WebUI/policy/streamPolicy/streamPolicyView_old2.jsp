...
$(document).ready(function() {
	checkFocusMessage($("#src_st_ip"),"최대 15자까지 가능합니다.");
	checkFocusMessage($("#mac_addr"),"최대 17자까지 가능합니다.");
	checkFocusMessage($("#rey_port"),"최소 2 ~ 65534까지 입력이 가능합니다.");
	checkFocusMessage($("#dst_ip"),"최대 15자까지 가능합니다.");
	checkFocusMessage($("#dst_port"),"최소 2 ~ 99까지 입력이 가능합니다.");
						...
						<table summary="연계정책목록" style="table-layout: fixed">
							...
							<tbody>
								...
								<tr>
									...
									<td><input type="text" class="text_input mid" id="src_st_ip" name="src_st_ip" onkeyup="onlySizeFillter(this,15)" placeholder="xxx.xxx.xxx.xxx" value="${streamPolicyForm.src_st_ip}"/> 
									</td>
								</tr>
							<%-- <tr>
								...
								<tr>
									...
									<label for="workNetworksPort">PORT</label> 
									<input type="text" class="text_input short t_center" id="dst_port" name="dst_port" onkeyup="onlyNumBetweenFillter(this,6,2,65534)" value="${streamPolicyForm.dst_port}"/></td>
								</tr>
								<tr>
