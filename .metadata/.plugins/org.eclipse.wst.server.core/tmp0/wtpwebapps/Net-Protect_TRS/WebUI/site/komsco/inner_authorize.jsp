...
<%
	...
	sso_id = (String)session.getAttribute("EMP_CODE");
	...
	String ssUserId =  (String) request.getSession().getServletContext().getContext("/").getAttribute("sso_id");

	request.getSession().getServletContext().getContext("/").setAttribute("sso_id","");	//초기화
	String ssUserId2 =  (String) request.getSession().getServletContext().getContext("/").getAttribute("sso_id");	//초기화 확인
	System.out.println("1 = "+ssUserId);
	System.out.println("2 = "+ssUserId2);

	session.setAttribute("sso_id", ssUserId);
	result = "success";
%>
